...
public class mnp extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null && session.getAttribute("username") != null && session.getAttribute("role") != null) {
            ...
            switch (role) {
                case "Manager":
                    request.getRequestDispatcher("/WEB-INF/views/mnp.jsp").forward(request, response);
                    break;
                default:
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null && session.getAttribute("username") != null && session.getAttribute("role") != null) {
            ...
            try {
                r = SQLConnection.UpdateThreePara("procInsertNewProject",request.getParameter("prjn"),request.getParameter("prjo"),request.getParameter("prjcc"));
                while (r.next()) {
